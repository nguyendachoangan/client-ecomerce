        ...
        <div className="w-main flex items-center justify-between">
          <div className="flex flex-col flex-1">
            ...
            <small className="text-[13px] text-gray-300">
              Subscribe now and receive a weekly newsletter
            </small>
          </div>
          <div className="flex-1 flex items-center">
            ...
            />
            <div className="h-[56px] w-[56px] bg-[#F04646] rounded-r-full flex items-center justify-center text-white text-[13px]">
              <MdEmail size={18} />
            </div>
          </div>
        </div>
