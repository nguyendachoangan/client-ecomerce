...
import { ProductExtraInfomation } from "../../ultils/contans";
    ...
    <div className={clsx("w-full")}>
      ...
      <div
        ...
        className={clsx(
          ...
          isQuickView
            ? "max-w-[900px] gap-16 max-h-[80vh] overflow-y-auto"
            : "w-main"
        )}
      >
        <div
        ...
        >
          ...
          <div className="w-[458px]">
            <Slider
              {...settings}
              className="image-slider  gap-2 justify-between"
            >
              {currentProduct.images.map((image, index) => (
                <div key={index} className="flex-1">
                  <img
                    ...
                    src={image}
                    alt={`image-${index}`}
                    className="h-[100px] w-[100px] cursor-pointer border object-cover"
                  />
                </div>
              ))}
            </Slider>
        ...
        <div
          className={clsx(
            "w-2/5 pr-[42px] flex flex-col gap-4",
            isQuickView && "w-1/2"
          )}
        >
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-sm [text-main italic text-main">{`(Sold: ${product?.sold} pieces) `}</span>
          </div>
