...
import { BiEdit, BiTrash, BiCustomize } from "react-icons/bi";
        ...
        <tbody>
          {products?.map((el, idx) => (
            <tr className="border-b" key={el._id}>
              ...
              <td className="text-center py-2 flex">
                <span
                  onClick={() => setEditProduct(el)}
                  className="text-blue-500 hover:text-orange-500 cursor-pointer px-1"
                >
                  <BiEdit size={20} />
                </span>
                <span
